...
2. Os campos - "isAdm"  e “isActive” devem receber um valor booleano ( ¨True” ou ¨False¨), sinalizando respectivamente se o dev é administrador do site e se sua conta está ativa.
...
Deve ser feito um soft delete na rota de deletar usuário.
