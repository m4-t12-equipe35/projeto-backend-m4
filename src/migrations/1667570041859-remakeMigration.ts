...
export class remakeMigration1667570041859 implements MigrationInterface {
    name = 'remakeMigration1667570041859'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "email" character varying(70) NOT NULL, "stack" character varying(10) NOT NULL, "password" character varying(150) NOT NULL, "isAdm" boolean NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "score" integer NOT NULL DEFAULT '0', CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_questions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isAnswered" boolean NOT NULL DEFAULT false, "isRight" boolean NOT NULL, "questionsId" uuid, "userId" uuid, CONSTRAINT "PK_57bcdfc90c43f8b16813b7687a4" PRIMARY KEY ("id"))`);
